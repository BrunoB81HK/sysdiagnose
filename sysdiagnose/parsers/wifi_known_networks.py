...
version_string = "wifi_known_networks.py v2023-05-19 Version 1.0"
            ...
            try:
                with open(path, "rb") as fp:
                    ...
                    if config.debug:
                        ...
                        print(
                            json.dumps(result, indent=4, cls=CustomEncoder),
                            file=sys.stderr,
                        )
...
def main():
    ...
    parser.add_option(
        ...
        dest="inputfile",
        action="store",
        type="string",  # XXX #35 FIXME! Here we should pass on a glob **.plist like in mobileactivation.py's main()
